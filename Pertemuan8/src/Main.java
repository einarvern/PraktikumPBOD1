public class Main {
    public static void main(String[] args) {
        ...
        d1.setIsi(new Anggora("Marnie", 5.2));
        d2.setIsi(new Kembangtelon("Krobus", 6.1));
        d3.setIsi(new Anjing("Chou"));
        ...
        System.out.println("Integer - Sesudah Tukar: a=" + a.getIsi() + ", b=" + a.getIsi()); 
        ...
        kelompokAnabul.setIsi(1, new Anggora("Nana", 4.6));
        kelompokAnabul.setIsi(2, new Kembangtelon("Harith", 3.9));
        kelompokAnabul.setIsi(3, new Anjing("Franco"));
        ...
        kelompokKucing.setIsi(1, new Anggora("Nana", 4.6));
        kelompokKucing.setIsi(2, new Kembangtelon("Harith", 3.9));
        ...
        System.out.println("Total isi Dataa: " + kelompokKucing.getSize());
        ...
        System.out.println("Total bobt kucing di Data: " + totalBobotKucing + " kg");
    }
}